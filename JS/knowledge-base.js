    ...
    this.responses={
      matematica:{
        fracoes:{
          ...
          materials:[{title:"Vídeo: Frações e Decimais",url:"https://www.youtube.com/watch?v=def456",icon:"play"},{title:"Atividades com Frações",url:"https://www.example.com/jogos-fracao",icon:"question-circle"}]
        },
        porcentagem:{
          ...
          materials:[{title:"Calculadora de Porcentagem",url:"https://www.example.com/calc-porcentagem",icon:"calculator"},{title:"Vídeo: Porcentagem no Dia a Dia",url:"https://www.youtube.com/watch?v=pqr123",icon:"play"}]
        },
        geometria:{
          ...
          materials:[{title:"Calculadora de Áreas",url:"https://www.example.com/calculadora",icon:"calculator"},{title:"Vídeo: Geometria Básica",url:"https://www.youtube.com/watch?v=ghi789",icon:"play"}]
        }
      },
      portugues:{
        sujeito_predicado:{
          ...
          materials:[{title:"Vídeo: Sujeito e Predicado",url:"https://www.youtube.com/watch?v=jkl012",icon:"play"},{title:"Exercícios Interativos",url:"https://www.example.com/exercicios-sintaxe",icon:"pencil-alt"}]
        },
        acentuacao:{
          ...
          materials:[{title:"Guia de Acentuação",url:"https://www.example.com/acentuacao",icon:"book"},{title:"Quiz de Acentos",url:"https://www.example.com/quiz-acentos",icon:"question-circle"}]
        },
        interpretacao:{
          ...
          materials:[{title:"Textos para Praticar",url:"https://www.example.com/textos-interpretacao",icon:"book-reader"},{title:"Técnicas de Leitura",url:"https://www.example.com/tecnicas-leitura",icon:"glasses"}]
        }
      },
      ciencias:{
        celula:{
          ...
          materials:[{title:"Vídeo: Viagem pela Célula",url:"https://www.youtube.com/watch?v=mno345",icon:"play"},{title:"Jogo: Monte uma Célula",url:"https://www.example.com/jogo-celula",icon:"gamepad"}]
        },
        sistema_solar:{
          ...
          materials:[{title:"Simulador do Sistema Solar",url:"https://www.example.com/simulador-solar",icon:"globe"},{title:"Vídeo: Viagem pelos Planetas",url:"https://www.youtube.com/watch?v=pqr678",icon:"play"}]
        },
        agua:{
          ...
          materials:[{title:"Experimento: Ciclo da Água",url:"https://www.example.com/experimento-agua",icon:"tint"},{title:"Vídeo: Estados da Água",url:"https://www.youtube.com/watch?v=stu901",icon:"play"}]
        }
      },
      geral:{
        saudacao:{
