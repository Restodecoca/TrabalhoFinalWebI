...
function handleFeedbackSubmission() {
  ...
  if (!type || !text) { showNotification('Por favor, preencha todos os campos obrigatórios.', 'error'); return; }
...
function updateContentForUserType(t){
  const txt = {student:'Olá, aluno! Estou aqui para ajudar com suas dúvidas escolares.',
...
function handleResponsiveDesign() {
  ...
  nav.querySelectorAll('a').forEach(a => a.addEventListener('click', () => {
    ...
    ic.classList.remove('fa-times'); ic.classList.add('fa-bars');
  }));
